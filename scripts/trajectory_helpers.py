...
class PregripToGrip(TrajectoryGenerator):
    ...
    @classmethod
    def trajectory(cls, controller: MetaController) -> tuple[Trajectory, Trajectory]:
        broom_pose = controller.plant.EvalBodyPoseInWorld(controller.plant_context, controller.body)
        robot_pos = controller.plant.EvalBodyPoseInWorld(controller.plant_context, controller.base).translation()
